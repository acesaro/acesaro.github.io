...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/kb/flexsearch.min.js');loadScript('/kb/en.search-data.min.558c3643eb258db38affdbcc1d790adb2f849a31e6b100d791258612306c84a0.js',function(){input.required=false;search();});}
