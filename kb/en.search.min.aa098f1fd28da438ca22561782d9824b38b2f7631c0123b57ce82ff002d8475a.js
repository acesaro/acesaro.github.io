...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/kb/flexsearch.min.js');loadScript('/kb/en.search-data.min.138209b36f923a01f50dbba7bcb8b67633dadc36a4650f6533c84134dae3fcab.js',function(){input.required=false;search();});}
