...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/kb/flexsearch.min.js');loadScript('/kb/en.search-data.min.58dcc9d1fd9bf62e07057244c741db4f5be8ba026c894ad8daed51d84d42fcba.js',function(){input.required=false;search();});}
